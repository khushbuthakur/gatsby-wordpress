                ...
                <div class="-mx-2 flex flex-wrap justify-between space-y-8 lg:space-y-0">
                    <div class="w-full px-2 lg:w-auto">
                        <a class="inline-block hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#">
                            ...
                            <h2 class="mt-1 font-black">Information Technology Services</h2>
                        </a>
                        ...
                        <div class="mt-8 -mx-1 flex items-center">
                            <a class="p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Facebook" title="Facebook">
                            ...
                            <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Twitter" title="Twitter">
                                <svg class="w-6 h-6" viewBox="0 0 24 24">
                            ...
                            <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Youtube" title="Youtube">
                                <svg class="w-6 h-6" viewBox="0 0 24 24">
                            ...
                            <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Linkedin" title="Linkedin">
                                <svg class="w-6 h-6" viewBox="0 0 24 24">
                            ...
                            <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Instagram" title="Instagram">
                                <svg class="w-6 h-6" viewBox="0 0 24 24">
                            ...
                            <a class="ml-2 p-1 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#" aria-label="Snapchat" title="Snapchat">
                                <svg class="w-6 h-6" viewBox="0 0 24 24">
                    ...
                    <div class="w-1/2 px-2 flex flex-col md:w-1/4 lg:w-auto">
                        ...
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Condimentum</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Amet Ornare</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Bibendum Mattis</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Purus Nibh</a>
                    </div>
                    <div class="w-1/2 px-2 flex flex-col md:w-1/4 lg:w-auto">
                        <h3 class="font-bold">Consectetur</h3>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Euismod Quam</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Cras Tristique </a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Etiam Tristique</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Sollicitudin</a>
                    </div>
                    <div class="w-1/2 px-2 flex flex-col md:w-1/4 lg:w-auto">
                        <h3 class="font-bold">Fermentum</h3>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Bibendum</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Tristique Cras</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Sit Malesuada</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Magna Inceptos</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Cras Tristique </a>
                    </div>
                    <div class="w-1/2 px-2 flex flex-col md:w-1/4 lg:w-auto">
                        <h3 class="font-bold">Ullamcorper</h3>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Condimentum</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Tellus</a>
                        <a class="mt-2 text-sm text-gray-300 hover:text-gray-400 focus:outline-none focus:ring focus:ring-blue-400" href="#">Quam Nibh</a>
                    </div>
                </div>
            </div>
    </footer>
