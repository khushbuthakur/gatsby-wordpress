...
function Footer1() {
    ...
    <div className="px-4 text-white lg:px-16">
        <div className="-mx-2 flex flex-wrap justify-between space-y-8 lg:space-y-0">
            ...
            <div className="w-1/2 px-2 flex flex-col md:w-1/2 lg:w-auto">
            ...
            <div className="w-full px-2 flex flex-col lg:w-auto">
                <form action="#" className="max-w-sm">
                    <h3 className="font-bold">Contact Us</h3>
                    <p className="mt-2 text-sm">Want to learn more, ask us a question.</p>
                    <div className="mt-4">
                        <label htmlFor="example-input" className="sr-only">Email</label>
                        <div className="flex items-stretch">
                            <input id="example-input" type="text" className="text-gray-600 border-transparent bg-gray-200 lg:text-sm focus:bg-white" placeholder="Your Email Address"/>
                            <button className="btn text-white border-transparent bg-red-600 hover:bg-red-800">Send</button>
                        </div>
                    </div>
                </form>
                <div className="mt-8 -mx-2 flex flex-wrap items-center text-xs divide-x divide-gray-200">
                    <a className="px-2 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#">
                        Facebook
                    </a>
                    <a className="px-2 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#">
                        Twitter
