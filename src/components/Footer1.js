        ...
        <div class="-mx-2 flex flex-wrap justify-between space-y-8 lg:space-y-0">
            ...
            <div class="w-full px-2 flex flex-col lg:w-auto">
                <form action="#" class="max-w-sm">
                    ...
                    <p class="mt-2 text-sm">Want to learn more, ask us a question.</p>
                    <div class="mt-4">
                        <label for="example-input" class="sr-only">Email</label>
                        <div class="flex items-stretch">
                            <input id="example-input" type="text" class="text-gray-600 border-transparent bg-gray-200 lg:text-sm focus:bg-white" placeholder="Your Email Address"/>
                            <button class="btn text-white border-transparent bg-red-600 hover:bg-red-800">Send</button>
                        </div>
                    </div>
                </form>
                <div class="mt-8 -mx-2 flex flex-wrap items-center text-xs divide-x divide-gray-200">
                    <a class="px-2 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#">
                        Facebook
                    </a>
                    <a class="px-2 hover:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" href="#">
                        Twitter
